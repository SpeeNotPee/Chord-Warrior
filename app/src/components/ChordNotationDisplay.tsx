...
export type NotationStyle = 'symbol' | 'roman';
...
/** Chord Notation mode: raw text chord symbols (e.g. "CΔ7") or Roman numerals (e.g. "ii7 - V7 - I"). */
export function ChordNotationDisplay({ chord, style }: ChordNotationDisplayProps) {
  ...
  const text = style === 'roman' ? chord.romanNumeral ?? chord.symbol : chord.symbol;
